...
Z2 = W1 * data + repmat(b1, 1, m); % hiddenSize by m (25 by 10,000)
a2 = sigmoid(Z2); % hiddenSize by m (25 by 10,000) 
...
rhoHat = sum(a2, 2) / m; % hiddenSize by 1 (25 by 1)
KL = sparsityParam * log(sparsityParam ./ rhoHat) + (1-sparsityParam) * (log((1-sparsityParam) ./ (1-rhoHat)));
spa = beta * sum(KL); % sparsity penalty term
...
W2grad = delta3 * a2' / m + lambda * W2; % visibleSize by hiddenSize (64 by 25)
b2grad = sum(delta3, 2) / m; % visibleSize by 1 (64 by 1)
